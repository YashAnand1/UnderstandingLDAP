...
The 20 questions mentioned within this document are strictly based on the [Sample-Directory](https://github.com/YashAnand1/UnderstandingLDAP/tree/main?tab=readme-ov-file#creating-a-directory) that has been created by me for the main 'Understanding LDAP' document. For understanding the structure of the directory for which these questions have been framed, click on the above hyperlink.   
